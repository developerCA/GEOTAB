      ...
      $ocLazyLoadProvider.config({
          ...
          modules: [
              ...
              },
              {
                  name: 'reporteador',
                  files: [                          
                      'js/app/reportes/reporteDirective.js',                
                  ]
              },
              {
                  name: 'xeditable',
              ...
              {
                  name: 'ui.iframeloader',
                  files: [
                      'js/directives/ui-iframeloader.js',
                  ]
              },
              {
                  ...
                  files : [
                        ...
                        'vendor/modules/angular-flotchart/plugins/jquery.colorhelpers.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.canvas.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.categories.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.crosshair.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.errorbars.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.fillbetween.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.image.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.navigate.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.pie.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.resize.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.selection.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.stack.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.symbol.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.threshold.js',

                                                                                              'vendor/modules/angular-flotchart/plugins/jquery.flot.time.js',

                                                                                              'vendor/modules/angular-flotchart/angular-flotchart.js'
              ...
              },
              {
                  name: 'barcode',
                  files: [
                      'vendor/modules/angular-barcode/plugins/JsBarcode.js',
                      'vendor/modules/angular-barcode/plugins/CODE128.js',
                      'vendor/modules/angular-barcode/barcode.js'
                      ]
              },
