...
(function(window, document, undefined) {
  ...
  angular.module('mgcrea.ngStrap.modal', [ 'mgcrea.ngStrap.core', 'mgcrea.ngStrap.helpers.dimensions' ]).provider('$modalStrap', function() {
    var defaults = this.defaults = {
      animation: 'am-fade',
    ...
    this.$get = [ '$window', '$rootScope', '$bsCompiler', '$animate', '$timeout', '$sce', 'dimensions', function($window, $rootScope, $bsCompiler, $animate, $timeout, $sce, dimensions) {
      ...
      function ModalFactory(config) {
        ...
        var promise = $modalStrap.$promise = $bsCompiler.compile(options);
        ...
        $modalStrap.show = function() {
          ...
          modalScope = $modalStrap.$scope.$new();
          modalElement = $modalStrap.$element = compileData.link(modalScope, function(clonedElement, scope) {});
        ...
        function destroyModalElement() {
          if ($modalStrap.$isShown && modalElement !== null) {
            unbindBackdropEvents();
            unbindKeyboardEvents();
          }
          if (modalScope) {
          ...
          if (modalElement) {
            modalElement.remove();
            modalElement = $modalStrap.$element = null;
          }
        }
        return $modalStrap;
      }
  ...
  angular.module('mgcrea.ngStrap.alert', [ 'mgcrea.ngStrap.modal' ]).provider('$alert', function() {
    ...
    this.$get = [ '$modalStrap', '$timeout', function($modalStrap, $timeout) {
      function AlertFactory(config) {
        var $alert = {};
        var options = angular.extend({}, defaults, config);
        $alert = $modalStrap(options);
